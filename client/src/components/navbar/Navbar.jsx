          ...
          <div className="relative">
           <Link to="cart"> <img src={assets.basket_icon} className="h-7 w-7" alt="" /></Link>
            {Object.keys(cartItems).length > 0 && (
              <div className="absolute -top-1 right-0 bg-red-500 h-4 w-4 text-white flex items-center justify-center rounded-full"><span className="text-xs font-semibold">{getCartCount()}</span></div>
            )}
          </div>
