...
const Footer = () => {
  return (
    <div id="footer" className="bg-black/70 px-4 md:px-36 pt-20">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 md:gap-64">
        <div>
          <img src={assets.logo} alt="" className="mb-6" />
          <p className="text-white">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Omnis
            numquam ipsum, error labore corrupti distinctio neque magnam ut
            consequuntur cum sapiente, illo necessitatibus fuga consectetur.
          </p>
