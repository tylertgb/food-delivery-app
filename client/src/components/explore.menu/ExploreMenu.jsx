    ...
    <div id='menu' className='pt-20 pb-10'>
        ...
        <div className='explore-menu-list flex items-center justify-between gap-3 md:gap-6 overflow-x-scroll w-full mt-8'>
            {menu_list.map((item, index) => {
                return(
                    <div onClick={() => setCategory(prev=>prev === item.menu_name ? 'All' : item.menu_name)} key={index} className='flex flex-col items-center gap-3 cursor-pointer w-36 min-w-36 my-5'>
